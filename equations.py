...
def build_dmax_deformed_flexspline(params: dict,
                                    dmax_x: float = 0.0,
                                    dmax_y: float = 0.0,
                                    n_ded_arc: int = 39,
                                    r_fillet_add: float = 0.2,
    ...
    The modifications are applied in local tooth coordinates before the
    deformation transform (Eqs 14, 21, 23, 27, 29).
